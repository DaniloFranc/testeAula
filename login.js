class Login{
    ...
    static endpoint="https://login--danilofranco1.repl.co/";
    ...
    static login=(callback_ok,callback_naook,config=null)=>{
        ...
        ".logoLogin{ display: flex; justify-content: flex-start; align-items: flex-start;width: 50%;background-color: #bbb;padding: 10px;border-radius: 0px 10px 10px 0px;box-sizing: inherit; }"+
    ...
    static verificaLogin=()=>{
        ...
        const endpoint=`https://login--danilofranco1.repl.co/?matricula=${mat}&senha=${pas}`;
        fetch(endpoint)
        .then(res=>res.json())
        .then(res=>{
            if(res){
